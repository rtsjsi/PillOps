...
export function getSeedData(): { medicines: Medicine[]; salesInvoices: SalesInvoice[] } {
  ...
  const medicines: Medicine[] = [
    ...
    },
    {
      ...
      packSize: '5', uom: 'Strip', ingredients: [{ salt: 'Azithromycin', strength: '500mg' }],
      storageConditions: 'Store below 25°C', isNarcotic: false, prescriptionRequired: true,
      substitutes: ['med-027'],
      batches: [
    ...
    },
    {
      ...
      packSize: '10', uom: 'Strip', ingredients: [{ salt: 'Amoxicillin', strength: '250mg' }],
      isNarcotic: false, prescriptionRequired: true,
      batches: [
    ...
    },
    {
      ...
      packSize: '10', uom: 'Strip', ingredients: [{ salt: 'Cetirizine Hydrochloride', strength: '10mg' }],
      substitutes: ['med-025'], isNarcotic: false, prescriptionRequired: false,
      batches: [
    ...
    },
    {
      ...
      packSize: '1', uom: 'Bottle', ingredients: [{ salt: 'Diphenhydramine', strength: '14.08mg/5ml' }],
      isNarcotic: false, prescriptionRequired: false,
      batches: [
    ...
    },
    {
      ...
      packSize: '1', uom: 'Vial', ingredients: [{ salt: 'Insulin Glargine', strength: '100IU/ml' }],
      storageConditions: 'Refrigerate 2-8°C', isNarcotic: false, prescriptionRequired: true,
      batches: [
    ...
    },
    {
      ...
      packSize: '1', uom: 'Sachet', ingredients: [{ salt: 'Sodium Chloride', strength: '2.6g' }, { salt: 'Potassium Chloride', strength: '1.5g' }],
      isNarcotic: false, prescriptionRequired: false,
      batches: [
    ...
    },
    {
      ...
      packSize: '15', uom: 'Strip', ingredients: [{ salt: 'Metformin Hydrochloride', strength: '500mg' }],
      isNarcotic: false, prescriptionRequired: true,
      batches: [
    ...
    },
    {
      ...
      schedule: 'OTC', gstPercent: 12, reorderLevel: 50, totalStock: 0, rack: 'A1-S1',
      packSize: '15', uom: 'Strip', ingredients: [{ salt: 'Paracetamol', strength: '650mg' }],
      isNarcotic: false, prescriptionRequired: false,
      batches: [
    ...
    },
    {
      ...
      packSize: '15', uom: 'Strip', ingredients: [{ salt: 'Pantoprazole Sodium', strength: '40mg' }],
      isNarcotic: false, prescriptionRequired: true,
      batches: [
    ...
    },
    {
      ...
      packSize: '15', uom: 'Strip', ingredients: [{ salt: 'Clopidogrel Bisulfate', strength: '75mg' }],
      isNarcotic: false, prescriptionRequired: true,
      batches: [
    ...
    },
    {
      ...
      schedule: 'H', gstPercent: 12, reorderLevel: 50, totalStock: 0, rack: 'A2-S1',
      packSize: '20', uom: 'Strip', ingredients: [{ salt: 'Omeprazole', strength: '20mg' }],
      isNarcotic: false, prescriptionRequired: true,
      batches: [
    ...
    },
    {
      ...
      packSize: '1', uom: 'Tube', ingredients: [{ salt: 'Povidone Iodine', strength: '5% w/w' }],
      isNarcotic: false, prescriptionRequired: false,
      batches: [
    ...
    },
    {
      ...
      packSize: '1', uom: 'Bottle', ingredients: [{ salt: 'Ciprofloxacin', strength: '0.3% w/v' }],
      isNarcotic: false, prescriptionRequired: true,
      batches: [
    ...
    },
    {
      ...
      packSize: '1', uom: 'Inhaler', ingredients: [{ salt: 'Salbutamol', strength: '100mcg/dose' }],
      isNarcotic: false, prescriptionRequired: true,
      batches: [
    ...
    },
    {
      ...
      packSize: '15', uom: 'Strip', ingredients: [{ salt: 'Atorvastatin Calcium', strength: '10mg' }],
      isNarcotic: false, prescriptionRequired: true,
      batches: [
    ...
    },
    {
      ...
      packSize: '15', uom: 'Strip', ingredients: [{ salt: 'Losartan Potassium', strength: '50mg' }],
      isNarcotic: false, prescriptionRequired: true,
      batches: [
    ...
    },
    {
      ...
      packSize: '15', uom: 'Strip', ingredients: [{ salt: 'Montelukast Sodium', strength: '10mg' }],
      isNarcotic: false, prescriptionRequired: true,
      batches: [
    ...
    },
    {
      ...
      packSize: '15', uom: 'Strip', ingredients: [{ salt: 'Ibuprofen', strength: '400mg' }],
      isNarcotic: false, prescriptionRequired: false,
      batches: [
    ...
    },
    {
      ...
      packSize: '30', uom: 'Strip', ingredients: [{ salt: 'Ranitidine Hydrochloride', strength: '150mg' }],
      isNarcotic: false, prescriptionRequired: true,
      batches: [
    ...
    },
    {
      ...
      packSize: '15', uom: 'Strip', ingredients: [{ salt: 'Domperidone', strength: '10mg' }],
      isNarcotic: false, prescriptionRequired: true,
      batches: [
    ...
    },
    {
      ...
      packSize: '1', uom: 'Sachet', ingredients: [{ salt: 'Cholecalciferol', strength: '60000IU' }],
      isNarcotic: false, prescriptionRequired: false,
      batches: [
    ...
    },
    {
      ...
      packSize: '1', uom: 'Tube', ingredients: [{ salt: 'Diclofenac Diethylamine', strength: '1.16% w/w' }],
      isNarcotic: false, prescriptionRequired: false,
      batches: [
    ...
    },
    {
      ...
      packSize: '15', uom: 'Strip', ingredients: [{ salt: 'Amlodipine Besylate', strength: '5mg' }],
      isNarcotic: false, prescriptionRequired: true,
      batches: [
    ...
    },
    {
      ...
      packSize: '10', uom: 'Strip', ingredients: [{ salt: 'Levocetirizine Dihydrochloride', strength: '5mg' }],
      substitutes: ['med-004'], isNarcotic: false, prescriptionRequired: false,
      batches: [
    ...
    },
    {
      ...
      packSize: '10', uom: 'Strip', ingredients: [{ salt: 'Ondansetron', strength: '4mg' }],
      isNarcotic: false, prescriptionRequired: true,
      batches: [
    ...
    },
    {
      ...
      packSize: '10', uom: 'Strip', ingredients: [{ salt: 'Cefixime', strength: '200mg' }],
      substitutes: ['med-002'], isNarcotic: false, prescriptionRequired: true,
      batches: [
    ...
    },
    {
      ...
      packSize: '30', uom: 'Bottle', ingredients: [{ salt: 'Multivitamins', strength: 'Complex' }],
      isNarcotic: false, prescriptionRequired: false,
      batches: [
    ...
    },
    {
      ...
      packSize: '1', uom: 'Tube', ingredients: [{ salt: 'Terbinafine', strength: '1% w/w' }],
      isNarcotic: false, prescriptionRequired: false,
      batches: [
    ...
    },
    {
      ...
      packSize: '15', uom: 'Strip', ingredients: [{ salt: 'Calcium', strength: '500mg' }, { salt: 'Vitamin D3', strength: '250IU' }],
      isNarcotic: false, prescriptionRequired: false,
      batches: [
